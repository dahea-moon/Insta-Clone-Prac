...
SECRET_KEY = 's@-jf6egho)uielob$^_rvn=l)5@)8z8==7f!=j$q50qun0-i2'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            # BASE_DIR/APP/templates/ 자동으로 탐색
...
# 기본 auth user model 말고 내가 확장한 user model을 쓸 것
